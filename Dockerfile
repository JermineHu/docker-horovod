...
# Download examples
RUN HName=horovod && wget https://github.com/uber/horovod/archive/master.zip -O ${HName}.zip && \
    unzip ${HName}.zip && mv ${HName}-master/examples /examples && \
    rm -rf ${HName}.zip ${HName}-master
